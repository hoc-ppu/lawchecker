...
# marshal_file_dir = "..\\example_files\\addedNames\\Amendment_Paper_XML\\"
...
if __name__ == "__main__":
    if len(sys.argv) != 5:
        print("Usage: python post-processing-html.py <template_path> <xml_file_path> <marshal_file_dir> <output_html_file_path>")
        sys.exit(1)
